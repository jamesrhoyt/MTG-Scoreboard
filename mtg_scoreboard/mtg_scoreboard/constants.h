...
const std::string avatarPath = "..\\..\\server\\data\\";
...
//Fonts:
extern sf::Font* sffont_mtg;
extern sf::Font* sffont_dejavu;
extern tgui::Font* tguifont_mtg;
extern tgui::Font* tguifont_dejavu;
...
struct player
{
	...
	tgui::TextArea::Ptr displayName;	//The TextBox to display the Player's name.
	...
	//Partner #1 Objects:
	tgui::TextArea::Ptr partnerDisplayNameOne;	//The TextBox to display the name of this Player's 1st Partner (if they have one).
	...
	//Partner #2 Objects:
	tgui::TextArea::Ptr partnerDisplayNameTwo;	//The TextBox to display the name of this Player's 2nd Partner (if they have one).
	...
	//Team Objects:
	tgui::TextArea::Ptr teamDisplayName;	//The TextBox to display the name of this Player's Team.
